...
enum cc_stat cc_deque_new_conf(CC_DequeConf const *const conf,
                               CC_Deque **deque);
...
enum cc_stat cc_deque_filter_mut(CC_Deque *deque,
                                 bool (*predicate)(const void *));
enum cc_stat cc_deque_filter(CC_Deque *deque, bool (*predicate)(const void *),
                             CC_Deque **out);
...
#define CC_DEQUE_FOREACH(val, deque, body)                                  \
    {                                                                       \
        ...
        void *val;                                                          \
        while (cc_deque_iter_next(&cc_deque_iter_53d46d2a04458e7b, &val) != \
               CC_ITER_END)                                                 \
            body                                                            \
    }
...
#define CC_DEQUE_FOREACH_ZIP(val1, val2, deque1, deque2, body)              \
    {                                                                       \
        ...
        cc_deque_zip_iter_init(&cc_deque_zip_iter_ea08d3e52f25883b, deque1, \
                               deque2);                                     \
        void *val1;                                                         \
        void *val2;                                                         \
        while (cc_deque_zip_iter_next(&cc_deque_zip_iter_ea08d3e52f25883b3, \
                                      &val1, &val2) != CC_ITER_END)         \
            body                                                            \
    }
